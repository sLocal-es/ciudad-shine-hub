...
const LeadMagnetForm = () => {
  ...
  const inputCls =
    "w-full bg-white text-black border border-border rounded-lg px-4 py-3 text-sm focus:outline-hidden focus:border-primary transition-colors placeholder:text-gray-600 caret-black";
