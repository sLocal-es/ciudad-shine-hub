...
import cityImg from "@/assets/cities/sevilla.jpg";

const WHATSAPP_URL =
  "https://wa.me/34684780063?text=" + encodeURIComponent("Hola, quiero posicionar mi negocio en Sevilla");

const sectores = [
  {
    "label": "SEO para fontaneros en Sevilla",
    "href": "/seo-para-fontaneros"
  },
  {
    "label": "SEO para fisioterapeutas en Sevilla",
    "href": "/seo-para-fisioterapeutas"
  },
  {
    "label": "SEO para empresas de reformas en Sevilla",
    "href": "/seo-para-reformas"
  },
  {
    "label": "SEO para pintores en Sevilla",
    "href": "/seo-para-pintores"
  },
  {
    "label": "SEO para clínicas en Sevilla",
    "href": "/seo-para-clinicas"
  },
  {
    "label": "SEO para entrenadores personales en Sevilla",
...
const SeoLocalSevilla = () => {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "SEO Local Sevilla", item: "https://slocal.es/seo-local-sevilla" },
    ],
  };
  ...
  return (
    <>
      <SEOHead
        ...
        description="¿Tu negocio en Sevilla no aparece en Google Maps? Posicionamos tu ficha y web para que tus clientes te encuentren primero. Desde 147€/mes + IVA."
        canonical="/seo-local-sevilla"
          ...
          <div>
            <BreadcrumbNav
              items={[
                { label: "Inicio", href: "/" },
                { label: "Localidades" },
                { label: "SEO Local Sevilla" },
              ]}
            />
            <h1 className="font-heading text-3xl md:text-4xl leading-tight mb-4">
              SEO Local en Sevilla: Que tus Clientes te Encuentren en Google
            </h1>
      ...
      <section className="py-16">
        <div className="container max-w-3xl">
          <h2 className="font-heading text-2xl md:text-3xl mb-6">
            Por qué los negocios en Sevilla necesitan SEO local
          </h2>
      ...
      <section className="bg-warm-bg py-16">
        <div className="container">
          <h2 className="font-heading text-2xl md:text-3xl mb-8">
            Cómo posicionamos tu negocio en Sevilla
          </h2>
      ...
      <section className="py-16">
        <div className="container">
          <h2 className="font-heading text-2xl md:text-3xl mb-3">
            SEO local para negocios en Sevilla por sector
          </h2>
          <p className="text-sm text-muted-foreground mb-8 max-w-2xl">
            Trabajamos con todo tipo de negocios locales en Sevilla. Cada sector tiene su propia competencia y sus propias búsquedas en la ciudad.
          </p>
      ...
      {/* FAQ */}
      <FAQSection title="Preguntas frecuentes sobre SEO local en Sevilla" items={faqs} />
      ...
      <section className="bg-primary py-16">
        <div className="container text-center">
          <h2 className="font-heading text-2xl md:text-3xl text-primary-foreground mb-6">
            ¿Tu negocio en Sevilla no aparece cuando tus clientes te buscan en Google?
          </h2>
          <a
            href={WHATSAPP_URL}
            target="_blank"
