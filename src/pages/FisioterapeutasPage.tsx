  ...
  return (
    <>
      <SEOHead
        ...
        description="SEO local para fisioterapeutas: ficha de Google Mi Negocio, web multipágina y posicionamiento local para captar pacientes desde Google. Desde 150 €/mes."
