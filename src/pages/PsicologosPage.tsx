  ...
  return (
    <>
      <SEOHead
        ...
        description="Haz que tu consulta de psicología aparezca cuando alguien busca psicólogo en tu ciudad. Agenda llena, sin depender del boca a boca ni de plataformas. Desde 147€/mes + IVA."
