...
import cityImg from "@/assets/cities/zaragoza.webp";

const WHATSAPP_URL =
  "https://wa.me/34684780063?text=" + encodeURIComponent("Hola, quiero posicionar mi negocio en Zaragoza");

const sectores = [
  {
    "label": "SEO para fontaneros en Zaragoza",
    "href": "/seo-para-fontaneros"
  },
  {
    "label": "SEO para fisioterapeutas en Zaragoza",
    "href": "/seo-para-fisioterapeutas"
  },
  {
    "label": "SEO para empresas de reformas en Zaragoza",
    "href": "/seo-para-reformas"
  },
  {
    "label": "SEO para pintores en Zaragoza",
    "href": "/seo-para-pintores"
  },
  {
    "label": "SEO para clínicas en Zaragoza",
    "href": "/seo-para-clinicas"
  },
  {
    "label": "SEO para entrenadores personales en Zaragoza",
...
const pasos = [
  {
    "n": "01",
    "title": "Optimizamos tu ficha de Google Business Profile para Zaragoza",
    "body": "Configuramos cada campo de tu perfil para las búsquedas de Zaragoza: categorías correctas, descripción con keywords locales, fotos, horarios y zona de servicio por barrios y distritos. Todo lo que Google necesita para mostrarte en el mapa de la ciudad."
  },
  {
    "n": "02",
    "title": "Creamos contenido que posiciona en búsquedas de Zaragoza",
    "body": "Artículos de blog y páginas de servicio optimizadas para las búsquedas que hacen tus clientes en Zaragoza, por barrio y por tipo de servicio."
  },
  {
    "n": "03",
    "title": "Seguimiento mensual de posiciones en Zaragoza",
    "body": "Cada mes ves exactamente qué posiciones has ganado en Google Maps para las búsquedas más importantes de tu sector en Zaragoza."
  }
];
...
const SeoLocalZaragoza = () => {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "SEO Local Zaragoza", item: "https://slocal.es/seo-local-zaragoza" },
    ],
  };
  ...
  return (
    <>
      <SEOHead
        ...
        description="¿Tu negocio en Zaragoza no aparece en Google Maps? Posicionamos tu ficha y web para que tus clientes te encuentren primero. Desde 147€/mes + IVA."
        canonical="/seo-local-zaragoza"
          ...
          <div>
            <BreadcrumbNav
              items={[
                { label: "Inicio", href: "/" },
                { label: "Localidades" },
                { label: "SEO Local Zaragoza" },
              ]}
            />
            <h1 className="font-heading text-3xl md:text-4xl leading-tight mb-4">
              SEO Local en Zaragoza: Que tus Clientes te Encuentren en Google
            </h1>
      ...
      <section className="py-16">
        <div className="container max-w-3xl">
          <h2 className="font-heading text-2xl md:text-3xl mb-6">
            Por qué los negocios en Zaragoza necesitan SEO local
          </h2>
      ...
      <section className="bg-warm-bg py-16">
        <div className="container">
          <h2 className="font-heading text-2xl md:text-3xl mb-8">
            Cómo posicionamos tu negocio en Zaragoza
          </h2>
      ...
      <section className="py-16">
        <div className="container">
          <h2 className="font-heading text-2xl md:text-3xl mb-3">
            SEO local para negocios en Zaragoza por sector
          </h2>
          <p className="text-sm text-muted-foreground mb-8 max-w-2xl">
            Trabajamos con todo tipo de negocios locales en Zaragoza. Cada sector tiene su propia competencia y sus propias búsquedas en la ciudad.
          </p>
      ...
      {/* FAQ */}
      <FAQSection title="Preguntas frecuentes sobre SEO local en Zaragoza" items={faqs} />
      ...
      <section className="bg-primary py-16">
        <div className="container text-center">
          <h2 className="font-heading text-2xl md:text-3xl text-primary-foreground mb-6">
            ¿Tu negocio en Zaragoza no aparece cuando tus clientes te buscan?
          </h2>
          <a
            href={WHATSAPP_URL}
            target="_blank"
...
export default SeoLocalZaragoza;
