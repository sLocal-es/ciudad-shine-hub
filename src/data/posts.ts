...
export const posts: BlogPost[] = [
  ...
  content: `
    ...
    <p>Trabajamos con <a href="/seo-para-fontaneros">fontaneros</a>, <a href="/seo-para-fisioterapeutas">fisioterapeutas</a>, <a href="/seo-para-reformas">empresas de reformas</a> y <a href="/seo-para-pintores">pintores</a> en toda España. Sin letra pequeña. <a href="/contacto">Hablemos →</a></p>
  `,
  faqs: [
  {
...

{
  ...
  content: `
    ...
    <p>Trabajamos con fontaneros, fisioterapeutas, clínicas, empresas de reformas y comercios locales en toda <a href="/seo-local-cordoba">Córdoba</a> y su área metropolitana. Hablas siempre con la misma persona, sin intermediarios.</p>
  ...
  faqs: [
    ...
    { q: "¿Cuánto cuesta el SEO local para un negocio en Córdoba?", a: "El plan de slocal.es para negocios cordobeses incluye gestión mensual de tu ficha de Google, contenido optimizado por barrio, gestión de reseñas e informe mensual de resultados. Hablas siempre con la misma persona, sin intermediarios. Consulta las condiciones del servicio." }
  ],
},
{
  ...
  altText: "Móvil mostrando resultados locales en Google Maps al buscar un servicio cerca",
