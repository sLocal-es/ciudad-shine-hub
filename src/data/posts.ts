...

{
  ...
  faqs: [
    ...
    { q: "¿Cuánto cuesta el SEO local para un negocio en Córdoba?", a: "El plan de slocal.es para negocios cordobeses incluye gestión mensual de tu ficha de Google, contenido optimizado por barrio, gestión de reseñas e informe mensual de resultados. Hablas siempre con la misma persona, sin intermediarios. Consulta condiciones sin compromiso." }
  ],
},
{
