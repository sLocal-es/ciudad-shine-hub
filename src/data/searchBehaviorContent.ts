...
export const sectorSearchContent: Record<string, SearchBehaviorContent> = {
  "seo-para-fontaneros": {
    ...
    slocalDifference: "El sistema de slocal.es para fontaneros en [ciudad] no es una agencia de publicidad. Trabaja mes a mes optimizando tu ficha de Google, posicionando tu web para búsquedas específicas de fontanería en cada zona de [ciudad] y midiendo los resultados con datos reales.",
  },
  "seo-para-reformas": {
