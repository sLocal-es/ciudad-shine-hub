// Search behavior paragraphs per sector (with [ciudad] and [sectorLabel] placeholders)
...
export const sectorSearchContent: Record<string, SearchBehaviorContent> = {
  ...
  "mas-alumnos-para-yoga": {
    ...
    competitionContext: {
      ...
      sevilla: "En Sevilla, la demanda de yoga crece cada año. Búsquedas como 'clases yoga Sevilla' o 'yoga Triana' tienen competencia digital muy baja.",
      malaga: "Málaga combina residentes y expatriados con alta afinidad al yoga. Las búsquedas se mantienen estables todo el año.",
      zaragoza: "En Zaragoza, la competencia entre estudios de yoga en Google es mínima. Es un mercado ideal para posicionarse rápido.",
      bilbao: "Bilbao tiene demanda estable de yoga con muy poca competencia digital. Los resultados llegan rápido.",
      murcia: "Murcia ofrece la menor competencia para estudios de yoga. Posicionarse es rápido y los resultados son inmediatos.",
    },
    gbpImportance: "Para un estudio de yoga en [ciudad], Google Maps es donde los alumnos potenciales toman la decisión. Ven fotos del espacio, horarios, reseñas y estilos de yoga — todo en un vistazo. Un estudio con buenas reseñas y estilos bien definidos transmite la energía correcta antes de que el alumno entre por la puerta.",
    slocalDifference: "El sistema de slocal.es para estudios de yoga en [ciudad] crea páginas por estilo: hatha, vinyasa, yoga prenatal, yoga restaurativo. Cada página captura alumnos que buscan exactamente ese tipo de yoga. Además, tu ficha refleja horarios actualizados y el ambiente de tu estudio para atraer al alumno ideal.",
  },
};
