...
export const sectors: SectorData[] = [
  {
    ...
    mockupResult: "Fontanero Urgencias Tu Ciudad | Disponible 24h",
  ...
  },
  {
    ...
    metaDesc: "Consigue más solicitudes de presupuesto para tu empresa de reformas desde Google con una ficha, una web y posicionamiento local.",
    h1: "Más Presupuestos para tu Empresa de Reformas desde Google",
    pillBadge: "Para reformas",
    painSubtitle: "El cliente que busca 'empresa de reformas en tu ciudad' ya tiene intención de contratar. Si no apareces, ese presupuesto se lo lleva otro.",
    painCards: [
      { icon: "🔍", text: "Tu empresa no aparece cuando buscan 'reformas en tu ciudad'" },
    ...
    mockupResult: "Empresa de Reformas en Tu Ciudad | Presupuesto Gratis",
    analyticsLine1: "Solicitudes de presupuesto: 14/mes ↑+38%",
    analyticsLine2: "Posición 'reformas tu ciudad': #3",
    ...
    webCard: {
      title: "Una web con página por servicio y zona",
      body: "Página por tipo de reforma (cocinas, baños, integrales) y por zona. El cliente que busca 'reforma de baño en tu barrio' llega directamente.",
    },
    reportCard: "clientes",
    faqs: [
      ...
      { q: "¿Cómo consigo más solicitudes de presupuesto desde Google?", a: "Con páginas específicas para cada tipo de reforma y cada zona donde trabajas. Cuando alguien busca 'reforma de cocina en tu barrio', tu página aparece directamente." },
  ...
  },
  {
    ...
    painCards: [
      { icon: "🔍", text: "Cuando buscan 'pintor en tu ciudad' no apareces entre los primeros" },
    ...
    mockupResult: "Pintor en Tu Ciudad | Pisos, Locales y Fachadas",
    analyticsLine1: "Contactos nuevos/mes: 19 ↑+52%",
    analyticsLine2: "Posición 'pintor piso tu ciudad': #2",
  ...
  },
  {
    ...
    painSubtitle: "Un paciente que busca 'clínica dental en tu ciudad' ya está listo para reservar cita. Si tu clínica no aparece, esa cita la agenda tu competencia.",
    painCards: [
    ...
    mockupResult: "Clínica Dental en Tu Ciudad | Primeras Visitas Sin Espera",
    analyticsLine1: "Citas reservadas nuevas: 34/mes ↑+61%",
    analyticsLine2: "Posición 'clínica dental tu ciudad': #1",
    ...
    webCard: {
      title: "Una web con página por servicio y zona",
      body: "Página por especialidad y por zona. La clínica dental que tiene página para 'ortodoncia en tu barrio' aparece donde otros no están.",
    },
  ...
  },
  {
    ...
    painCards: [
      { icon: "🔍", text: "Buscas 'fisioterapeuta en tu ciudad' y no apareces entre los primeros" },
    ...
    mockupResult: "Fisioterapeuta en Tu Ciudad | Cita Disponible Esta Semana",
    analyticsLine1: "Nuevos pacientes/mes: 22 ↑+48%",
    analyticsLine2: "Posición 'fisioterapeuta tu ciudad': #3",
    ...
    faqs: [
      ...
      { q: "¿Los pacientes buscan fisioterapeuta en Google?", a: "Sí, cada vez más. Búsquedas como 'fisioterapeuta cerca' o 'fisio para cervicales en tu ciudad' tienen miles de búsquedas mensuales en ciudades medianas." },
    ],
  ...
  },
  {
    ...
    painCards: [
      { icon: "🔍", text: "No apareces cuando buscan 'entrenador personal en tu ciudad'" },
    ...
    mockupResult: "Entrenador Personal en Tu Ciudad | Primera Sesión Gratis",
    analyticsLine1: "Consultas nuevas/mes: 17 ↑+44%",
    analyticsLine2: "Posición 'entrenador personal tu ciudad': #2",
    ...
    reportCard: "clientes",
    faqs: [
      { q: "¿Funciona para entrenadores que trabajan a domicilio o al aire libre?", a: "Sí. Posicionamos para 'entrenador personal a domicilio tu ciudad' o 'entrenamiento en parque tu ciudad'. La modalidad se refleja en la estrategia." },
  ...
  },
  {
    ...
    painSubtitle: "Hay personas en tu ciudad buscando 'clases de yoga en tu ciudad' ahora mismo. Si tu estudio no aparece entre los primeros, esos alumnos se apuntan a otro sitio.",
    painCards: [
    ...
    mockupResult: "Clases de Yoga en Tu Ciudad | Todos los Niveles",
    analyticsLine1: "Alumnos nuevos/mes: 11 ↑+37%",
    analyticsLine2: "Posición 'clases yoga tu ciudad': #1",
    ...
    reportCard: "alumnos",
    faqs: [
      { q: "¿Funciona para profesores sin estudio propio?", a: "Sí. Posicionamos para 'clases de yoga a domicilio tu ciudad' o el espacio donde impartes. No necesitas local propio." },
      { q: "¿Cómo compito con gimnasios que tienen yoga?", a: "El posicionamiento local favorece la especialización. Un estudio de yoga específico con buenas reseñas puede aparecer antes que un gimnasio genérico para búsquedas como 'yoga restaurativo tu ciudad'." },
